...
class FlightSearch:
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, is_direct = True):
        ...
        if response.status_code != 200:
            ...
            return None
        # print("Response of check flights \n\n")
        if is_direct == False:
            return response
        if response.json()["meta"]["count"] == 0 and is_direct == True:
            print("searching for flight with stops.")
            response = self.check_flights(origin_city_code, destination_city_code, from_time, to_time, is_direct = False)
